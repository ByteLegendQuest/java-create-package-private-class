...
`git clone https://github.com/ByteLegendQuest/java-create-package-private-class`

A project directory named `java-create-package-private-class` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-create-package-private-class` directory which is created just now.
